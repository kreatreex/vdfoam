...
if ( function_exists( 'soliloquy' ) ) { soliloquy( '48' ); }
?>
...
<?php
  ...
  /* Mattress grid */
?>
<section class="mattressgrid">
<div class="container">
<div class="row">
<?php 
  dynamic_sidebar( 'mattress_grid' ); ?>
</div>
</div>
</section>
<section class="sofagrid">
<div class="container">
<div class="row">
<?php 
  dynamic_sidebar( 'sofa_grid' ); ?>
</div>
</div>
</section>

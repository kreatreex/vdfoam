...
register_sidebar( array(
    'name'          => __('Mattress grid','zerif-lite'),
    'id'            => 'mattress_grid',
    'before_widget' => '<div id="mattress_grid">',
    'after_widget'  => '</div>',
    'before_title'  => '<h2>',
    'after_title'   => '</h2>',
  ) );
...
register_sidebar( array(
    'name'          => __('Sofa grid','zerif-lite'),
    'id'            => 'sofa_grid',
    'before_widget' => '<div id="sofa_grid">',
    'after_widget'  => '</div>',
    'before_title'  => '<h2>',
    'after_title'   => '</h2>',
  ) );
...
register_sidebar( array(
    'name'          => __('General grid','zerif-lite'),
    'id'            => 'general_grid',
    'before_widget' => '<div id="general_grid">',
    'after_widget'  => '</div>',
    'before_title'  => '<h2>',
    'after_title'   => '</h2>',
  ) );
...
function zerif_register_widgets() {    
    ...
    register_widget('zerif_mattress_widget');
    register_widget('zerif_sofa_widget');
    register_widget('zerif_general_widget');
...
/**************************/
/****** Mattress grid widget */
/************************/

if ( !class_exists( 'zerif_mattress_widget' ) ) {
    class zerif_mattress_widget extends WP_Widget {
        function __construct() {
            parent::__construct(
                // Base ID of your widget
                'zerif_mattress_widget', 

                // Widget name will appear in UI
                __('Mattress', 'mattress_grid_widget'), 

                // Widget description
                array( 'description' => __( 'Widget to display mattress grid', 'mattress_grid_widget' ), ) 
            );
        }
        ...
        public function widget( $args, $instance ) {
            $title = apply_filters( 'widget_title', $instance['title'] ); ?>
              ...
              <div class="col-lg-4 col-sm-4 grid-box">
            ...
            echo $args['before_title'] . $title . $args['after_title'];
                ...
                if ( ! empty( $instance['image_uri'] ) && ( $instance['image_uri'] != 'Upload Image' ) ) {
                    ...
                    $zerif_mattress_custom_media_id = wp_get_attachment_image_src( $instance["custom_media_id"] );
                    $alt                                = get_post_meta( $instance['custom_media_id'], '_wp_attachment_image_alt', true );

                    if ( ! empty( $zerif_mattress_custom_media_id ) && ! empty( $zerif_mattress_custom_media_id[0] ) ) {

                        echo '<div class="client-image hidden-xs">';

                        echo '<img src="' . esc_url( $zerif_mattress_custom_media_id[0] ) . '" alt="' . $alt . '" />';
        ...
        public function form( $instance ) {
            ...
            //else {
            //$title = __( 'New title', 'mattress_grid_widget' );
            //}
            // Widget admin form
            ?>
            <p>
...
if ( !class_exists( 'zerif_sofa_widget' ) ) {
    class zerif_sofa_widget extends WP_Widget {
        function __construct() {
            parent::__construct(
                // Base ID of your widget
                'zerif_sofa_widget', 
                ...
                // Widget name will appear in UI
                __('Sofa', 'sofa_grid_widget'), 

                // Widget description
                array( 'description' => __( 'Widget to display sofa grid', 'sofa_grid_widget' ), ) 
            );
        }
...
if ( !class_exists( 'zerif_general_widget' ) ) {
    class zerif_general_widget extends WP_Widget {
        function __construct() {
            parent::__construct(
                // Base ID of your widget
                'zerif_general_widget', 

                // Widget name will appear in UI
                __('General grid widget', 'general_grid_widget'), 

                // Widget description
                array( 'description' => __( 'Widget to display on general grid', 'general_grid_widget' ), ) 
            );
        }
